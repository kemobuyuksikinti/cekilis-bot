...
module.exports.run = async (client, message, args) => {
  ...
  if (
    ...
    return message.reply(
      ":x: Çekilişleri başlatmak için mesajları yönetme izinlerine sahip olmanız gerekir."
    );
  }
  ...
  if (!giveawayChannel) {
    return message.reply(":x: Geçerli bir kanaldan bahsetmelisin!");
  }
  ...
  message.reply(`Çekiliş başladı bol şanslar! ${giveawayChannel}!`);
}
